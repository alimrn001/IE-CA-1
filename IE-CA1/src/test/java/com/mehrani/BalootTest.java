...
public class BalootTest {
    ...
    public void ratingAddCmdTest() throws Exception {
        try {
            ...
            baloot.checkUserCmd("addCommodity {\"id\": 2, \"name\": \"Headphone\", \"providerId\": 3, \"price\": 35000, \"categories\": [\"Technology\", \"Phone2\"], \"rating\": 8.8, \"inStock\": 50}");
            baloot.checkUserCmd("addCommodity {\"id\": 3, \"name\": \"Headphone\", \"providerId\": 3, \"price\": 35000, \"categories\": [\"Technology\", \"Phone2\"], \"rating\": 8.8, \"inStock\": 50}");
            baloot.checkUserCmd("addCommodity {\"id\": 4, \"name\": \"Headphone\", \"providerId\": 3, \"price\": 35000, \"categories\": [\"Technology\", \"Phone\"], \"rating\": 8.8, \"inStock\": 50}");
